...
def fetch_all_companies():
    ...
    s3_key = "required_columns_companies.json"
    retries = 3
    delay_sec = 30
...
def fetch_company_json_from_s3(**kwargs):
    ...
    s3_hook.load_string(
        ...
        key='required_columns_companies.txt',
        bucket_name='zubairtests3ci',
        replace=True
    )
...
s3_file_name = 'required_columns_companies.txt'
bucket_name = 'zubairtests3ci'
...
with DAG(
    dag_id = 'Fetch_Companies_min_properties_final',
