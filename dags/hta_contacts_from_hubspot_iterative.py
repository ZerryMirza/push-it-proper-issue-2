...
def fetch_all_contacts():
    ...
    contact_property_dictionary = {'firstname': 'First Name',
                                   ...
                                   'viable_leads': 'Viable Leads',
                                   'leads_temperature': 'Leads Temperature',
...
with DAG(
    dag_id = 'HTA_Fetch_Contact_min_properties_v1',
    ...
    task_create_contacts_table = RedshiftSQLOperator(
        ...
        sql="""
            ...
            hs_user_ids_of_all_owners VARCHAR(255),
            ...
            ip_country_code VARCHAR(80),
            viable_leads INT,
            leads_temperature VARCHAR(255),
